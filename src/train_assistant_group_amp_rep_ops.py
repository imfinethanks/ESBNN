...
from bnext_rep_ops import BNext, BasicBlock
...
parser.add_argument('--rep_beta', type=int, default=2,
                    help='rep_beta')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    if args.teacher_num >0:
        ...
        if args.assistant_teacher_num >= 2:
            if args.model == "bnext_large":
                assistant_teachers.append(models.efficientnet_b4(pretrained=True,pretrained_cfg=_cfg(url='', file='/mnt/vepfs/ML/ml-public/PublicDataset/BNN/BNext/efficientnet_b4_ra2_320-7eb33cd5.pth')))
                print("using efficient_b4 as assistant teacher")    
            else:
                assistant_teachers.append(models.efficientnet_b2(pretrained=True,pretrained_cfg=_cfg(url='', file='/mnt/vepfs/ML/ml-public/PublicDataset/BNN/BNext/efficientnet_b2_ra-bcdf34b7.pth')))
                print("using efficient_b2 as assistant teacher")
        
        if args.assistant_teacher_num >= 3:
            if args.model == "bnext_large":
                assistant_teachers.append(models.convnext_tiny(pretrained=True,pretrained_cfg=_cfg(url='', file='/mnt/vepfs/ML/ml-public/PublicDataset/BNN/BNext/convnext_tiny_1k_224_ema.pth')))
        ...
        if args.assistant_teacher_num >= 4:
            assistant_teacher.append(models.convnext_tiny(pretrained=True,pretrained_cfg=_cfg(url='', file='/mnt/vepfs/ML/ml-public/PublicDataset/BNN/BNext/convnext_tiny_1k_224_ema.pth')))
        ...
        if args.assistant_teacher_num >= 3:
            model_teacher.append(models.convnext_tiny(pretrained=True,pretrained_cfg=_cfg(url='', file='/mnt/vepfs/ML/ml-public/PublicDataset/BNN/BNext/convnext_tiny_1k_224_ema.pth')))
            print("using convnext_tiny as main teacher")
        
        elif args.assistant_teacher_num == 2:
            model_teacher.append(models.efficientnet_b4(pretrained=True,pretrained_cfg=_cfg(url='', file='/mnt/vepfs/ML/ml-public/PublicDataset/BNN/BNext/efficientnet_b4_ra2_320-7eb33cd5.pth')))
            print("using efficient_b4 as main teacher")
 
        elif args.assistant_teacher_num == 1:
            model_teacher.append(models.efficientnet_b2(pretrained=True,pretrained_cfg=_cfg(url='', file='/mnt/vepfs/ML/ml-public/PublicDataset/BNN/BNext/efficientnet_b2_ra-bcdf34b7.pth')))
    ...
    if args.model == "bnext_tiny":
        model_student = BNext(num_classes = CLASSES, size = "tiny", ELM_Attention = args.elm_attention, Infor_Recoupling = args.infor_recoupling,rep_beta=args.rep_beta)
    elif args.model == "bnext_small":
        model_student = BNext(num_classes = CLASSES, size = "small", ELM_Attention = args.elm_attention, Infor_Recoupling = args.infor_recoupling,rep_beta=args.rep_beta)
    elif args.model == "bnext_middle":
        model_student = BNext(num_classes = CLASSES, size = "middle", ELM_Attention = args.elm_attention, Infor_Recoupling = args.infor_recoupling,rep_beta=args.rep_beta)
    elif args.model == "bnext_large":
        model_student = BNext(num_classes = CLASSES, size = "large", ELM_Attention = args.elm_attention, Infor_Recoupling = args.infor_recoupling,rep_beta=args.rep_beta)
    ...
    checkpoint_tar = os.path.join(args.save + "_{}_optimizer_{}_mixup_{}_cutmix_{}_aug_repeats_{}_KD_{}_assistant_{}_{}_HK_{}_{}_aa_{}__elm_{}_recoup_{}_0_amp_rep_512_ops".format(args.model, args.optimizer, args.mixup, args.cutmix, args.aug_repeats, args.teacher_num, args.assistant_teacher_num, args.weak_teacher, args.hard_knowledge, args.hard_knowledge_grains, args.aa, args.elm_attention, args.infor_recoupling,args.rep_beta), 'checkpoint.pth.tar')
    ...
    while epoch < args.epochs:
        ...
        if not args.multiprocessing_distributed or args.local_rank == 0:
            save_checkpoint({
                ...
                'alpha': alpha,
                }, is_best, args.save + "_" + "{}_optimizer_{}_mixup_{}_cutmix_{}_aug_repeats_{}_KD_{}_assistant_{}_{}_HK_{}_{}_aa_{}__elm_{}_recoup_{}_{}_amp_rep_{}_ops".format(args.model, args.optimizer, args.mixup, args.cutmix, args.aug_repeats, args.teacher_num, args.assistant_teacher_num, args.weak_teacher, args.hard_knowledge, args.hard_knowledge_grains, args.aa, args.elm_attention, args.infor_recoupling, args.gpu, args.rep_beta), epoch = epoch)
