...
from bnext_rep import BNext, BasicBlock
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    checkpoint_tar = os.path.join(args.save + "_{}_optimizer_{}_mixup_{}_cutmix_{}_aug_repeats_{}_KD_{}_assistant_{}_{}_HK_{}_{}_aa_{}__elm_{}_recoup_{}_0_amp_rep_{}".format(args.model, args.optimizer, args.mixup, args.cutmix, args.aug_repeats, args.teacher_num, args.assistant_teacher_num, args.weak_teacher, args.hard_knowledge, args.hard_knowledge_grains, args.aa, args.elm_attention, args.infor_recoupling,args.rep_beta), 'checkpoint.pth.tar')
    ...
    while epoch < args.epochs:
        ...
        if not args.multiprocessing_distributed or args.local_rank == 0:
            save_checkpoint({
                ...
                'alpha': alpha,
                }, is_best, args.save + "_" + "{}_optimizer_{}_mixup_{}_cutmix_{}_aug_repeats_{}_KD_{}_assistant_{}_{}_HK_{}_{}_aa_{}__elm_{}_recoup_{}_{}_amp_rep_{}".format(args.model, args.optimizer, args.mixup, args.cutmix, args.aug_repeats, args.teacher_num, args.assistant_teacher_num, args.weak_teacher, args.hard_knowledge, args.hard_knowledge_grains, args.aa, args.elm_attention, args.infor_recoupling, args.gpu, args.epochs,args.rep_beta), epoch = epoch)
